...
import 'app/data/services/remote/exchange_api.dart';
    ...
    MultiProvider(
        providers: [
          ...
          Provider<WsRepository>(
              create: (_) => WsRepositoryImpl((ids)=>WebSocketChannel.connect(Uri.parse('wss://ws.coincap.io/prices?assets=${ids.join(',')}')),
              )
          )
        ],
        child: const MyApp()),
